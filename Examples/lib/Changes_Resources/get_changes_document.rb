...
module GroupDocsComparisonExamples
  ...
  class GetChangesDocument
    def changes_document
      ...
      request = GroupDocsComparisonCloud::PutChangesDocumentRequest.new(GetComparisonRequest(@sourcefile, @targetfile),@outputfile)
  ...
  object = GetChangesDocument.new()
  object.changes_document()
end

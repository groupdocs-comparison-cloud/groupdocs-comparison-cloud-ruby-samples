...
module GroupDocsComparisonExamples
  ...
  class GetChangesImages
    def changes_images
      ...
      request = GroupDocsComparisonCloud::PutChangesImagesRequest.new(GetComparisonRequest(@sourcefile, @targetfile),@outputfile)
  ...
  object = GetChangesImages.new()
  object.changes_images()
end

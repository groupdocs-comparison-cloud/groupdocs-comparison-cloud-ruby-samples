...
module GroupDocsComparisonExamples
  ...
  class GetChangesImagesStream
    def changes_images_stream
      ...
      request = GroupDocsComparisonCloud::PutChangesImagesStreamRequest.new(GetComparisonRequest(@sourcefile, @targetfile))
  ...
  object = GetChangesImagesStream.new()
  object.changes_images_stream()
end

...
module GroupDocsComparisonExamples
  ...
  class GetChangesDocumentStream
    def changes_document_stream
      ...
      request = GroupDocsComparisonCloud::PutChangesDocumentStreamRequest.new(GetComparisonRequest(@sourcefile, @targetfile))
  ...
  object = GetChangesDocumentStream.new()
  object.changes_document_stream()
end

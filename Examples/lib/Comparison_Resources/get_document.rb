...
module GroupDocsComparisonExamples
  ...
  class GetDocument
    def get_comparison_document
      ...
      request = GroupDocsComparisonCloud::ComparisonRequest1.new(GetComparisonRequest(@sourcefile, @targetfile),@outputfile)
  ...
  object = GetDocument.new()
  object.get_comparison_document()
end

...
module GroupDocsComparisonExamples
  ...
  class GetComparisonImagesStream
    def comparison_images_stream
      ...
      request = GroupDocsComparisonCloud::ComparisonImagesStreamRequest.new(GetComparisonRequest(@sourcefile, @targetfile))
  ...
  object = GetComparisonImagesStream.new()
  object.comparison_images_stream()
end

...
module GroupDocsComparisonExamples
  ...
  class GetComparisonDocumentStream
    def comparison_document_stream
      ...
      request = GroupDocsComparisonCloud::ComparisonStreamRequest.new(GetComparisonRequest(@sourcefile, @targetfile))
  ...
  object = GetComparisonDocumentStream.new()
  object.comparison_document_stream()
end
